...
import (
	...
	"example.com/eagle-eye/services/zone-service/internal/endpoints"
	"example.com/eagle-eye/services/zone-service/internal/service"
	transporthttp "example.com/eagle-eye/services/zone-service/internal/transport/http"
	"example.com/eagle-eye/shared/logger"
	sharedmiddleware "example.com/eagle-eye/shared/middleware"
)

const serviceName = "zone-service"
