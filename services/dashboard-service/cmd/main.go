...
import (
	...
	"example.com/eagle-eye/services/dashboard-service/internal/endpoints"
	"example.com/eagle-eye/services/dashboard-service/internal/service"
	transporthttp "example.com/eagle-eye/services/dashboard-service/internal/transport/http"
	"example.com/eagle-eye/shared/logger"
	sharedmiddleware "example.com/eagle-eye/shared/middleware"
)

const serviceName = "dashboard-service"
